...
RSpec.describe User, type: :model do
  ...
  it "ユーザー名が５１文字以上の場合は登録できないこと" do
  ...
  it "メールアドレスが256文字以上の場合は登録できないこと" do
  ...
  it "メールアドレスがvalid_addressesの場合は登録できないこと" do
  ...
  it "メールアドレスがinvalid_addressesの場合は登録できないこと" do
  ...
  it "メールアドレスは小文字に変換されて登録されること" do
